...
if($err_foto == 's'){ echo'O valor escolhido para imagem é inválido<br>   '; $ERRO=$ERRO+1; }
if($Senha != $ConfSenha) { $ERRO=$ERRO + 1; echo'As senhas não conferem<br>   '; }
if ($Nome==null || $Email==null || $Senha==null || $ConfSenha==null  || $CPF==null) { $ERRO=$ERRO + 1; echo 'Campos requisitados não foram preenchidos<br>   ';}
if ($Nome=="" || $Email==""|| $Senha=="" || $ConfSenha=="" || $CPF=="") { $ERRO=$ERRO + 1; echo 'Campos requisitados não foram preenchidos<br>   ';

}


if($ERRO == 0) {
    $comando = "UPDATE usuario SET Email='$Email', Senha='".md5($Senha)."', Nome='$Nome', Cidade='$Cidade', Pais='$Pais', Endereco='$Endereco', CEP='$CEP', CPF='$CPF', Sexo='$Sexo', Celular='$Celular', Estado_Civil='$Estado_Civil', Foto='$Foto' WHERE Email = '$Email_session' ";
...
<script>
   ...
   <h1 style="font-size: 50pt;" class="fine">Alteração realizada com sucesso :)</h1>
